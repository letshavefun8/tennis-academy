...
- **Деплой фронта:** скилл `/deploy-frontend` — бамп `?v=N` у всех ссылок с `?v=` в index.html +
...
- **Версионирование ассетов:** при деплое фронта обязательно бампать `?v=N` у ВСЕХ ссылок,
  где он есть (`grep '?v=' index.html` — ассеты И иконки), иначе браузеры детей отдадут старый кеш
